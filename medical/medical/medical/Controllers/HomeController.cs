...
namespace medical.Controllers
{
    ...
    {
        private MedikalWebDBContext db = new MedikalWebDBContext();
        // GET: Home
        [Route("")]
        [Route("Anasayfa")]
        ...
        public ActionResult Iletisim(string adsoyad = null, string email = null, string konu = null, string mesaj = null)
        {
            ...
            if (adsoyad != null && email != null)
            {
                ...
                WebMail.UserName = "yildizturangokcen9@gmail.com";
                WebMail.Password = "wpge lfdu ifqg jmtp";
                WebMail.SmtpPort = 587;
                WebMail.Send("yildizturangokcen9@gmail.com", konu, email + "-" + mesaj);
